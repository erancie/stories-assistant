...
function Session({ userData,
  ...
  return (
    <>
      <Walkthrough />   {/* has to be here for buttons */}
      ...
      <div className={`session-controls ${(promptNo!==3)&&'session-controls-popup-active'} ${(promptNo===1) && ' prompt-1'} ${(promptNo===2) && ' prompt-2'}`} >
        ...
        <button className={`speak button col-12 my-3 mt-5`} 
      ...
      {currentSession 
        ...
        <div className='session'>
          ...
          <button className='leave-session-button' onClick={()=>setCurrentSession(null)}>
            Leave
          </button>
