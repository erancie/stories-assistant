      ...
      <div className='profile'>
        ...
        { userData &&
          ...
          <div className={`profile-icon my-2`}
               style={{right: `${profileOpen ? '325px' : '1.2rem'}`, position: `${profileOpen ? 'fixed' : 'absolute'}`}} 
          ...
          <Popup show={setProfileOpen} 
            ...
            {/* help / info */}
            <div className={`help `} onClick={()=>{setPromptNo(1); setProfileOpen(false)}} disabled={isThinking || isListening} >
            ...
            {/* Logout Button */}
            <div className='logout-button m-2 me-sm-4 p-1' 
                    onClick={()=>{
